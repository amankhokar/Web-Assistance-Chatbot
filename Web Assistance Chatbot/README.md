...
**Built for:** Humanli.ai AI/ML Engineer Assignment  
**Developer:** Data Science Fresher  
**Duration:** 2-3 Days
...
**Alternatives Considered:** GPT-4, Open-source LLMs (LLaMA, Mistral)
...
**Comparison:**
| Model | Cost/1K tokens | Speed | Context | Setup |
|-------|---------------|-------|---------|-------|
| GPT-3.5-Turbo | $0.002 | ⚡⚡⚡ | 16K | Easy |
| GPT-4 | $0.03 | ⚡⚡ | 128K | Easy |
| LLaMA-2-7B | Free | ⚡ | 4K | Complex |
...
- **Embeddings:** "Sentence-BERT: Sentence Embeddings using Siamese BERT-Networks" (Reimers & Gurevych, 2019)

### Tutorials
- [Building RAG Applications](https://www.pinecone.io/learn/retrieval-augmented-generation/)
- [Streamlit Chat Interfaces](https://docs.streamlit.io/knowledge-base/tutorials/build-conversational-apps)
...
This project is created for educational purposes as part of the Humanli.ai AI/ML Engineer assignment.
...
Built as part of Humanli.ai AI/ML Engineer Assignment  
Duration: 2-3 Days  
...
- **Humanli.ai** for the assignment opportunity
...
**Version:** 1.0.0  
**Status:** Assignment Submission Ready ✅
